            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Motherboard Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-sm-12 col-md-6">
                                        <label for="motherboardName">Name</label>
                                        <input type="text" class="form-control" value="<?php echo $row['name']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" <?php echo ($row['with_ram']==1 ? 'checked' : ''); ?> disabled>
                                        <label class="form-check-label" for="withAdapter"> RAM</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" <?php echo ($row['with_cpu']==1 ? 'checked' : ''); ?> disabled>
                                        <label class="form-check-label" for="withAdapter"> CPU</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" <?php echo ($row['with_fan']==1 ? 'checked' : ''); ?> disabled>
                                        <label class="form-check-label" for="withAdapter"> FAN</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Problem</label>
