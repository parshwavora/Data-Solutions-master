                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT customer.name,harddisk.* FROM customer RIGHT JOIN harddisk ON customer.id = harddisk.customer_id";
                                    ...
                                    if (mysqli_num_rows($result) > 0){
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="viewStorageDeviceDetails.php?customerId=<?php echo $row['customer_id'];?>&id=<?php echo $row['id'];?>&type=harddisk">
                                                        <?php echo $row['id']; ?>
                                                    </a>
                                                </td>
                                                <td>
