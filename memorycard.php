          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $sql = "SELECT customer.name 'customer_name',memorycard.* FROM customer RIGHT JOIN memorycard ON customer.id = memorycard.customer_id";
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="outward.php?customerId=<?php echo $row['customer_id'];?>&id=<?php echo $row['id'];?>&type=memorycard">
